...
{
    public partial class Returning2 : Form
    {
        public Returning2()
        {
            InitializeComponent();
        ...
        {
            string qkcpId = textBox1.Text;

            SqlCommand cmd = new SqlCommand("p_returning2", MainForm.conn);
            ...
            //传入参数
            cmd.Parameters["@copyId"].Value = qkcpId;
            ...
            try
            {
                ...
                if (code.Equals("OK"))
                {
                    lbMessage.Text = "提示：读者 "+account+" 成功归还期刊"+title;
                }
                else
                {
